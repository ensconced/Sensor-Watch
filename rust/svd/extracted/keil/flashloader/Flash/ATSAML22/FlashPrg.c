...
/* ---- SAM L22 ------------------------------------------------------------------*/
#if defined ATSAML22_256 || defined ATSAML22_128 || defined ATSAML22_64 || defined ATSAML22_32
  #define PAC_BASE             0x40000000
  #define NVMCTRL_BASE         0x41004000        /* SAML21                     */
#endif

#if defined ATSAML22_256
  #define FLASH_SIZE           0x40000
#endif

#if defined ATSAML22_128
  #define FLASH_SIZE           0x20000
#endif

#if defined ATSAML22_64
  #define FLASH_SIZE           0x10000
#endif

#if defined ATSAML22_32
